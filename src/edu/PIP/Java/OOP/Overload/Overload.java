package edu.PIP.Java.OOP.Overload;
/**
 * Demonstrating Overloading methods/function with average function
 */
/*
 * Precondition: Add parameters value
 * Postcondition: Return average
 */
public class Overload {

	public static void main(String[] args) {
		//Calling upon Overloading methods within the class
	...
	//These are Overloading methods, they have the same name by either different data types or parameter
